...
const mockListings = [
  ...
  },
  {
    ...
    description: 'Assorted fresh herbs including basil, rosemary, and thyme',
    price: 4.50,
    originalPrice: 7.00,
    quantity: '2 bundles',
    soldQuantity: '0',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <Link
            ...
            className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-3 rounded-lg hover:from-green-600 hover:to-emerald-600 transition-all duration-200 flex items-center"
          >
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-3 gap-4 mb-4 text-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-900">{listing.soldQuantity}</p>
                  </div>
                </div>
        ...
        {filteredListings.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-600 mb-4">Create your first listing to start selling your produce</p>
            <Link
              href="/dashboard/farmer/add-listing"
              className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-3 rounded-lg hover:from-green-600 hover:to-emerald-600 transition-all duration-200 inline-flex items-center"
            >
              <Plus className="w-5 h-5 mr-2" />
