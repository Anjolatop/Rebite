...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('🎉 Login successful! Welcome to Rebite!');
  ...
  const benefits = [
    "Access to exclusive food deals",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/auth/register" className="text-gray-600 hover:text-orange-600 transition-colors">
                Register
              </Link>
            </div>
          </div>
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-orange-100 text-lg leading-relaxed">
                Welcome back! Continue your journey of reducing food waste and building sustainable communities.
              </p>
            </div>
            ...
            <div className="mt-8 p-6 bg-white/10 rounded-2xl">
              ...
              <p className="text-orange-100 text-sm">
                Track your progress, see your environmental impact, and discover new opportunities to make a difference.
              </p>
            </div>
          </motion.div>
        </div>
